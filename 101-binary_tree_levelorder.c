...
/**
 * binary_tree_height - a function that goes through
 ...
 *
 * Return: 0 if it's the root or the number of depth
 */
...
/**
 * recursion - a function that goes through the complete tree and
 * each stores each node in linked_node function
 * @head: pointer to head of linked list
 * @tree: node to check
 *
...
/**
 * binary_tree_levelorder - a function that print the nodes
 * element in a lever-order
 * @tree: root node
